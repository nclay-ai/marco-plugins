...
[Lobe Chat](https://github.com/lobehub/lobe-chat) accesses [`Plugins Index`][website-url] from this repo to show user
the list of available plugins for Function Calling.
...
If you wish to add a plugin onto the index, make an entry in `plugins` directory using `plugin-template.json`, write a
short description and tag it appropriately then open as a pull request ty!
...
> - If you wish to have your plugin removed, or believes the description does not properly describe your plugin, please
...
Interact with Ahrefs directly from OuterBox Chat for keyword research, backlink audits, rank tracking, and competitive SEO insights.

`outerbox` `ahrefs` `seo`

---

### [OBx Chat Data Buddy](https://lobechat.com/discover/plugin/obx-chat-data-buddy)

<sup>By **[@OBxChat](https://outerboxai.com)** on **2025-03-23**</sup>

Your AI partner for data queries. Send your question to the OBx Data Chat API and receive contextualized responses that are integrated into natural language replies by OBxChat.

`outerbox` `data` `analytics` `chat` `buddy`

---

### [OuterBox IT Buddy](https://lobechat.com/discover/plugin/obx-it-buddy)

<sup>By **[@OBxChat](https://outerboxai.com)** on **2025-03-23**</sup>

Your AI partner for IT tasks, leveraging GPT-4o for advanced technical support and step-by-step solutions.

`outerbox` `it` `buddy`

---

### [OBxAI DataChat](https://lobechat.com/discover/plugin/obx-data-chat)

<sup>By **[@OBxChat](https://outerboxai.com)** on **2025-01-14**</sup>

OBxAI DataChat is a robust plugin designed to enable OuterBox employees to interact with company chat data using natural language. Whether you're searching for specific conversations, analyzing communication trends, or retrieving valuable insights from past interactions, this tool offers accurate and contextually relevant information to support your needs.

`business-intelligence`

---

### [OBxAI Handbook Helper](https://lobechat.com/discover/plugin/obx-handbook-helper)

<sup>By **[@OBxChat](https://outerboxai.com)** on **2025-01-14**</sup>

OBxAI Handbook Helper is an AI-powered assistant designed to help OuterBox employees quickly find information in the company handbook. Whether you're looking for policies, procedures, or company guidelines, this tool provides accurate and up-to-date search results.

`internal-knowledge`

---

### [OBxAI SmartSearch](https://lobechat.com/discover/plugin/obx-search-engine)

<sup>By **[@OBxChat](https://outerboxai.com)** on **2025-01-14**</sup>

OBxAI SmartSearch is an AI-powered search plugin that MUST activate any time users are searching for general knowledge about people, places, businesses, events, news. This powerful tool can browse the web for up-to-date search results.

`web-search`

---

### [OBxAI Web Crawler](https://lobechat.com/discover/plugin/obx-website-crawler)
...
Contributions of all types are more than welcome, if you are interested in contributing plugin, feel free to show us
what you’re made of.
...
- **[🤖 Lobe Chat](https://github.com/lobehub/lobe-chat)** - An open-source, extensible (Function Calling),
  high-performance chatbot framework. It supports one-click free deployment of your private ChatGPT/LLM web application.
- **[🤖 / 🏪 Agent Index](https://github.com/lobehub/lobe-chat-agents)** - Lobe Chat accesses index.json from this repo to
  show user the list of available agents for LobeChat.
