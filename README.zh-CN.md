...
[Lobe Chat](https://github.com/lobehub/lobe-chat) 从该存储库访问 [`Plugin Index`][website-url] 来为用户展示可用的
Function Calling 插件列表。
...
RESTRICTED: Read-only Salesforce data access. Query contacts, accounts, leads, opportunities. NO write operations. NO other platforms.

`salesforce` `read-only` `query` `crm` `data-retrieval` `sfdc`

---

### [OuterBox Ahrefs 代理](https://lobechat.com/discover/plugin/obx-ahrefs-agent)

<sup>By **[@OBxChat](https://outerboxai.com)** on **2025-06-09**</sup>

直接通过 OuterBox 聊天与 Ahrefs 互动，进行关键词研究、反向链接审计、排名跟踪和竞争性 SEO 洞察。

`outerbox` `ahrefs` `seo`

---

### [OBx 聊天数据助手](https://lobechat.com/discover/plugin/obx-chat-data-buddy)

<sup>By **[@OBxChat](https://outerboxai.com)** on **2025-03-23**</sup>

您的数据查询AI伙伴。将您的问题发送到 OBx 数据聊天 API，并通过 OBxChat 接收自然语言回复中集成的上下文响应。

`outerbox` `数据` `分析` `聊天` `助手`

---

### [OuterBox IT 伙伴](https://lobechat.com/discover/plugin/obx-it-buddy)

<sup>By **[@OBxChat](https://outerboxai.com)** on **2025-03-23**</sup>

您的 OuterBox AI 合作伙伴，用于 IT 任务

`outerbox` `it` `伙伴`

---

### [OBxAI 数据聊天](https://lobechat.com/discover/plugin/obx-data-chat)

<sup>By **[@OBxChat](https://outerboxai.com)** on **2025-01-14**</sup>

OBxAI 数据聊天是一个强大的插件，旨在使OuterBox员工能够使用自然语言与公司聊天数据进行交互。无论您是在搜索特定对话、分析沟通趋势，还是从过去的互动中获取有价值的见解，该工具都能提供准确且上下文相关的信息来支持您的需求。

`商业智能`

---

### [OBxAI 手册助手](https://lobechat.com/discover/plugin/obx-handbook-helper)

<sup>By **[@OBxChat](https://outerboxai.com)** on **2025-01-14**</sup>

OBxAI 手册助手是一个由 AI 驱动的助手，旨在帮助 OuterBox 员工快速查找公司手册中的信息。无论您在寻找政策、程序还是公司指南，该工具都能提供准确和最新的搜索结果。

`内部知识`

---

### [OBxAI 智能搜索](https://lobechat.com/discover/plugin/obx-search-engine)

<sup>By **[@OBxChat](https://outerboxai.com)** on **2025-01-14**</sup>

OBxAI 智能搜索是一个由 AI 驱动的搜索插件，用户在搜索关于人物、地点、企业、事件、新闻的常识时必须激活。这个强大的工具可以浏览网络以获取最新的搜索结果。

`网络搜索`

---

### [OBxAI 网络爬虫](https://lobechat.com/discover/plugin/obx-website-crawler)
...
- **[🤖 Lobe Chat](https://github.com/lobehub/lobe-chat)** - LobeChat 是一个开源的、可扩展的（Function
  Calling）高性能聊天机器人框架，支持一键免费部署私人 ChatGPT/LLM 网页应用程序
- **[🤖 / 🏪 Agent Index](https://github.com/lobehub/lobe-chat-agents)** - Lobe Chat 从该存储库访问 index.json 来为用户展示可用的
  LobeChat 助手列表。
